...
namespace Vampire.RL.Visualization
{
    ...
    public class RLMonsterVisualizer : MonoBehaviour
    {
        ...
        [SerializeField] private float healthBarHeight = 0.3f;
        ...
        private void CreateVisualizerUI()
        {
            ...
            if (showActionLabel)
            {
                actionLabelUI = CreateTextElement("ActionLabel", new Vector3(0, 1.5f, 0), 2f, Color.white);
            }
        ...
        private void CreateHealthBar()
        {
            ...
            healthBarRect.sizeDelta = new Vector2(1.5f, 0.2f);
        ...
        private void UpdateVisuals()
        {
            ...
            if (showHealthBar && baseMonster)
            {
                ...
                if (healthBarRect)
                {
                    ...
                    healthBarRect.anchoredPosition = new Vector3(-(1.5f * (1 - healthRatio)) / 2, 0, 0);
                }
        ...
        private void UpdateActionDisplay()
        {
            ...
            // Add animation: fade out over time
