# 3.3. Kết quả thực nghiệm (Co-op Survivors RL)

Chương này trình bày kết quả huấn luyện và suy luận mô hình RL đa agent cho trò chơi sinh tồn Co-op. Các kết quả bao gồm hiệu năng tác vụ (survival time, kill count, team DPS), chất lượng chính sách, hiệu năng hệ thống (FPS, inference latency, băng thông), và so sánh giữa các thiết lập khác nhau.
