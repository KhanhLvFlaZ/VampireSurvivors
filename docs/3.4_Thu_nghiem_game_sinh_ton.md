# 3.4. Thử nghiệm game sinh tồn

Chương này trình bày kết quả kiểm thử toàn diện game Vampire Survivors với tích hợp mô hình RL, bao gồm kiểm thử chức năng (functionality), hiệu năng (performance), độ ổn định (stability), tương thích hệ thống, và trải nghiệm người chơi.
